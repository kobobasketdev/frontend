...
export type TItem = { productId: number, name: string, weight: { value: number, measurement: string }, price: number, locationPrice: number, isWishListItem: boolean, images: string[], promotion?: TPromotionInfo };
